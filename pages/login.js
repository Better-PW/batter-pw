    ...
    return (
      <div className="h-screen flex flex-col justify-center text-center content-center subpixel-antialiased font-poppins">
        ...
        <div className={"flex flex-row mt-5 justify-center " + (sentOtp ? "visible" : "invisible")}> {/* has phone number -> login with otp */}
          <input className="w-64 mx-2 px-5 rounded-lg drop-shadow-xl text-black tracking-wide placeholder:text-gray-400" type="tel" required minLength="6" maxLength="6" name="otp" placeholder="Enter OTP" pattern="\d*" onChange={(e) => { setOtp(e.target.value) }} />
        ...
        <div className={"flex flex-row justify-center " + (sentOtp ? "invisible" : "visible")}> {/* no phone number -> show phone number input */}
          <input className="w-64 mx-2 px-5 rounded-lg drop-shadow-xl text-black tracking-wide placeholder:text-gray-400" type="tel" required minLength="10" maxLength="10" name="phone" placeholder="Enter Phone Number Here" pattern="\d*" onChange={(e) => { setPhone(e.target.value) }} />
