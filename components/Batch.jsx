    ...
    return (
        <div className="ease-in-out duration-500 flex hover:shadow-2xl bg-[#ffffff] hover:scale-105 dark:bg-[#494949] flex-col p-3 pb-0 rounded-md shadow-xl">
            <div className="rounded-md shadow-xl">
                <Image className="rounded-md" width={720} height={360} layout="responsive" src={`/api/image-proxy?imageUrl=${thumbnailUrl}`} alt={batchJson.name + " Thumbnail"} />
            </div>
